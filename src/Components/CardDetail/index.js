...
function CardDetail(props) {
  return (
    <div style={{background: "var(--primary)", z_index:"-1"}}>
      ...
      <p style={{color:"var(--accentPlum)"}}>Summary: <p style={{color:"var(--bgGrn)", fontSize:"18px"}}>{props.summary}</p></p>
      <p style={{color:"var(--accentPlum)", fontSize:"1rem"}}>Sentiment: <h4>{props.sentiment}</h4></p>
      <a href="{props.url}"style={{color:"var(--accentPlum)", font_size:"5px"}}>Go to article </a>
    </div>
  );
}
