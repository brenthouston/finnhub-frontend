...
//   console.log("chartAPI DATA: ",data.data["Time Series (Daily)"]);
//   try{
//     if(data.data.length !=0){
//     const prices = data.data["Time Series (Daily)"].split(0,29).map((["Time Series (Daily)"])) =>({
//       x: new Date(["Time Series Dz"])
//     })
//     }
//   }
//   catch (error){
...
const handleInputChange = event =>{
  ...
  return (
    <div className="container">
      ...
      <div className="row ">
        {/* Chart */}
        <div className="col-6 card mt-5" style={{height:"348px",background:"var(--accentLight)"}}>
        <div className="app">
        <div className="row">
